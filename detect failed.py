...
def callbackFunction(data):
    global allowProcessing
    allowProcessing=data.data
...
#starting the ROS talker here
    global talker, client, allowProcessing
    ...
    listener = roslibpy.Topic(client, '/humanDetectionControl', 'std_msgs/Bool')
...
#    (save_dir / 'labels' if save_txt else save_dir).mkdir(parents=False, exist_ok=True)  # make dir
    ...
    listener.subscribe(callbackFunction)
